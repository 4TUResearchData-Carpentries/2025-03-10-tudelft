...
venue: "Pendulum room 0.36 (Fontys building), Eindhoven University of Technology "        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "Laplace 37 5612 AZ Eindhoven"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
humandate: "March 10-11, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:30 - 16:30  CEST"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["Leila M. Iñigo de la Cruz"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Nami Sunami", "Niek Brom","Johns Bons","Linda Chen-Zijlstra","Özgün Balaban"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
eventbrite:  https://www.eventbrite.nl/e/introduction-to-version-control-with-git-tickets-1245873403889?aff=oddtdtcreator&internal_ref=social         # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
